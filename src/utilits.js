...
export const stickyNav = () => {
  ...
  const stickys = document.querySelectorAll(".Guerrilla_tm_header");
...
// Moveing effect
export const Guerrilla_tm_moving_animation = () => {
...
export const scroll_ = () => {
  const sections = document.querySelectorAll(".Guerrilla_tm_section");
